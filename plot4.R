...
plot(e$Datetimecol,e$Voltage,type="l",ylab="voltage",xlab="datetime")
...
plot(e$Datetimecol,e$Global_reactive_power,type="l",ylab="Global Reactive Power",xlab="datetime")
dev.off()
